    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
       ...
       <a href="{{ route('alternatives.index') }}"
           class="flex items-center font-bold
             {{ request()->routeIs('alternatives.*')
               ? 'bg-gray-400 text-gray-900'
               : 'text-gray-200 bg-gray-800 hover:bg-gray-400 hover:text-gray-900'
             }}
             p-2 rounded-lg group">
          <svg class="w-5 h-5 text-gray-500 transition duration-75" fill="currentColor" viewBox="0 0 22 21" xmlns="http://www.w3.org/2000/svg">
